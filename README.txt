# Standard Cross-Cultural Sample of Religion (SCCSR.v3)

There are two files inside the repository's metadata folder. See documentation below.
...
A human readable report on the SCCSR.v3 including a recommended citation, copyright information, preservation information and ethical considerations.
This file also includes a data and metata profile and a repository profile, providing an in-depth analysis of the dataset and the repository where it resides.
